    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('NC', 'New collection'), ('T', 'Trending'), ('OBG', 'Old but gold')], max_length=4)),
                ('home_page_image', models.ImageField(blank=True, null=True, upload_to='uploads/')),
                ('shop_grid_image', models.ImageField(blank=True, null=True, upload_to='uploads/')),
                ...
                ('featured_products', models.CharField(blank=True, choices=[('NA', 'New arrival'), ('BS', 'Best selling'), ('OS', 'On sale'), ('FY', 'For you')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered', models.BooleanField(default=False)),
                ('order_identifier', models.IntegerField(blank=True, default=0, null=True)),
