...
! function(a, d, p) {
    ...
    a.fn.scrollUp = function(l) {
        ...
        var o, e, r, s, t, c = a.fn.scrollUp.settings = a.extend({}, a.fn.scrollUp.defaults, l),
            i = !1,
            n = c.scrollTrigger ? a(c.scrollTrigger) : a("<a/>", {
                id: c.scrollName,
                href: "#top"
            });
...
! function(i) {
    ...
    (e = function() {
        ...
        if (!0 === i.options.infinite)
            ...
            for (; e < i.slideCount;) ++o, e = t + i.options.slidesToScroll, t += i.options.slidesToScrol <= i.options.slidesToShow ? i.options.slidesToScroll : i.options.slidesToShow;
